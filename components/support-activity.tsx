...
import { IconShieldCheck, IconStack, IconWand, IconUsersGroup, IconArrowRight } from "@tabler/icons-react";
		...
		<Card className={cn("gap-0 shadow-none dark:ring-0", className)} {...props}>
			...
			<div className="flex items-center justify-center">
				<Button size="sm" variant="ghost" render={<a href="/#" />} nativeButton={false}>View All
                						<IconArrowRight aria-hidden="true" data-icon="inline-end" /></Button>
			</div>
		</Card>
	);
}
